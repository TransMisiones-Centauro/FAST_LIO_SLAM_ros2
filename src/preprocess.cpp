...
void Preprocess::process(const livox_interfaces::msg::CustomMsg::ConstSharedPtr msg, PointCloudXYZI::Ptr &pcl_out)
{  
  avia_handler(msg);
  *pcl_out = pl_surf;
}
...
void Preprocess::avia_handler(const livox_interfaces::msg::CustomMsg::ConstSharedPtr msg)
{
  pl_surf.clear();
  pl_corn.clear();
  pl_full.clear();
